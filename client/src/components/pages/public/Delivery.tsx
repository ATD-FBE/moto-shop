            ...
            <div className="delivery-main">
                <div className="section-info">
                    ...
                    <ul className="mt-short">
                        <li>
                            <b>Карта онлайн</b> — теперь всё официально и без костылей!
                            Оплата проходит моментально через ЮKassa (Visa, Mastercard, МИР).
                            Безопасно, быстро, как хороший спортбайк.
                            {' '}
                            <span className="color-green">💳</span>
                        </li>
                        <li>
                            <b>Наличные</b> при получении заказа
                            (для любителей классики при самовывозе или доставке).
                        </li>
                        <li>
                            <b>Банковский перевод</b>
                            (для тех, кто любит цифры, контроль и бумажную бухгалтерию).
                        </li>
                    </ul>
                    ...
                    <p className="left-border mt-short">
                        ...
                        {' '}
                        — иначе наши админы включат режим детективов, а это может задержать отправку.
                        <br />
                        Вы также можете оплатить заказ частями различными способами, не только выбранным.
                        Комбинируйте на здоровье!
                        {' '}
