...
import type { TCompanyDetailsPdfResponse } from '@shared/types/index.js';

const COMPANY_TIMEOUT = 20000;

/// Генерация и загрузка реквизитов магазина в pdf ///
export const sendCompanyDetailsPdfRequest = (): TAppThunk<Promise<TCompanyDetailsPdfResponse>> =>
    async (dispatch) => {
